            ...
            <div class="container-xxl position-relative p-0">
                ...
                <div class="container-xxl py-5 bg-dark hero-header mb-5">
                    <div class="container text-center my-5 pt-5 pb-4">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Transaksi</h1>
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h5 class="section-title ff-secondary text-center text-warning fw-normal">On Going</h5>
                        <!-- <h1 class="mb-5">Explore Our Services</h1> -->
                    </div>
                    <a href="/addmenu"><button class="btn btn-outline-dark mb-4 mt-4"><i
                        ...
                        <form @submit.prevent="checkoutnow">
                            <div class="modal-body">
                                ...
                                <select required class="form-control" v-model="checkout.id_user" id="user">
                                    <option v-for="nama in kasir" :key="nama.id_user" :value="nama.id_user">{{ nama.nama }}
                                    </option>
                                </select>
