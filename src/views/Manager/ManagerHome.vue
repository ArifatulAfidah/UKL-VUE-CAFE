                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0 pe-4">
                            <a href="/manager" class="nav-item nav-link active">Home</a>
                            <a href="/alltransaction" class="nav-item nav-link">Semua Transaksi</a>
                    ...
                    <div class="container my-5 py-5">
                        <div class="row align-items-center g-5">
                            <div class="col-lg-6 text-center text-lg-start">
                                <h1 class="display-3 text-white animated slideInLeft">Welcome<br>CAFEKU</h1>
                                ...
                                <a href="" class="btn btn-warning py-sm-3 px-sm-5 me-3 animated slideInLeft">Manager</a>
                            </div>
